...
<div class="container mx-auto px-4 py-12">
    ...
    <div class="max-w-4xl mx-auto mt-12 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-8 text-center">
        ...
        <div class="flex flex-wrap justify-center gap-4">
            ...
            <a href="mailto:{{ setting('contact_email') }}" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition shadow-md">
            ...
            <a href="tel:{{ setting('contact_phone') }}" class="inline-flex items-center px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition shadow-md">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
