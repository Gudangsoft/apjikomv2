                    ...
                    <form action='{{ route("member.profile.update") }}' method='POST' enctype='multipart/form-data'>
                        ...
                        <div class='space-y-4'>
                            ...
                            <div class='flex items-center gap-3'>
                                ...
                                <input type='url' name='scirep_id' value='{{ old("scirep_id", $member->scirep_id) }}' placeholder='https://www.scirepid.com/authors/...' class='flex-1 px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all text-sm'>
                            </div>
                        </div>
