                    ...
                    <div class="space-y-2 mb-5">
                        ...
                        <div class="flex items-center text-sm text-gray-500">
                            ...
                            @elseif(($event->event_type ?? 'offline') === 'hybrid')
                                ...
                                <span class="font-medium text-green-600 line-clamp-1">Hybrid{{ $event->location ? ' · ' . $event->location : '' }}</span>
                            @else
                                ...
                                <span class="font-medium line-clamp-1">{{ $event->location ?: 'Lokasi TBA' }}</span>
                            @endif
                        </div>
                    </div>
