...
<div class="bg-white rounded-lg shadow p-6">
    ...
    <form method="POST" action="{{ route('admin.news.store') }}" enctype="multipart/form-data" id="newsForm">
        ...
        <div class="flex justify-end space-x-3">
            ...
            <button type="submit" class="px-6 py-2 bg-[#00629B] text-white rounded hover:bg-[#003A5D]">Simpan Berita</button>
        </div>
    </form>
</div>

@include('admin.news.partials.editor-scripts', ['initialContent' => old('content', '')])
