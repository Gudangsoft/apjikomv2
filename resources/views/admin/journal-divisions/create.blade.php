...
@section('page-title', 'Tambah Divisi Jurnal')

@section('content')
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Tambah Divisi Jurnal</h2>
                    </div>

                    <form action="{{ route('admin.journal-divisions.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="main_focus" id="main_focus" value="{{ old('main_focus') }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="journal_potential" id="journal_potential" value="{{ old('journal_potential') }}" 
