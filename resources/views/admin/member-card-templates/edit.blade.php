...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-6">Edit Template Kartu Anggota</h1>

        <form method="POST" action="{{ route('admin.card-templates.update', $cardTemplate) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <img src="{{ asset('storage/' . $cardTemplate->template_image) }}" 
                     ...
                     class="max-w-2xl rounded shadow-lg mb-4">
            </div>

            <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 mb-2">
                    Upload Template Background Baru (Optional)
                </label>
                ...
                <p class="text-xs text-gray-500 mt-1">Biarkan kosong jika tidak ingin mengubah. Format: JPG, PNG. Maksimal 5MB</p>
            ...
            <div class="mb-6">
                <label class="flex items-center space-x-2 cursor-pointer">
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', $cardTemplate->is_active) ? 'checked' : '' }}
