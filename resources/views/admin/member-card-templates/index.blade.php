...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden {{ $template->is_active ? 'ring-4 ring-green-500' : '' }}">
            <div class="relative">
            ...
            <div class="p-4">
                ...
                <div class="text-xs text-gray-500 mb-4">
                    <p>Dibuat: {{ $template->created_at->format('d M Y') }}</p>
                </div>
                
                <div class="flex space-x-2">
                    @if(!$template->is_active)
                    <form method="POST" action="{{ route('admin.card-templates.activate', $template) }}" class="flex-1">
                        @csrf
                        <button type="submit" 
                    ...
                    <a href="{{ route('admin.card-templates.edit', $template) }}" 
