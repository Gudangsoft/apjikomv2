...
<div class="bg-white rounded-lg shadow p-6">
    ...
    <!-- Photo Display Section (View Only - Member uploads from their dashboard) -->
    <div class="mt-8 pt-6 border-t">
        <h4 class="text-lg font-semibold mb-4 text-gray-900">Foto Member</h4>
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-green-700 mt-1">Member dapat mengubah foto melalui dashboard mereka.</p>
                            </div>
                        </div>
                    </div>
                @else
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-blue-700 mt-1">Member dapat upload foto melalui dashboard mereka di menu Profile.</p>
                            </div>
                        </div>
                    </div>
                @endif
