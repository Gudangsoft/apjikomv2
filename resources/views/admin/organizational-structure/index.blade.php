...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6 bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg">
        <div class="flex items-start">
            ...
            <div class="flex-1">
                <h3 class="text-sm font-semibold text-blue-800 mb-1">👥 Struktur Organisasi</h3>
                <p class="text-sm text-blue-700 mb-2">
                    Kelola <strong>Pengurus Inti</strong> (Ketua, Wakil, Sekretaris, Bendahara) dan <strong>Divisi</strong>. 
                    Gunakan tombol <strong>+ Tambah</strong> untuk menambah pengurus baru. Pastikan urutan sudah benar!
                </p>
            </div>
        </div>
    </div>
