...
<div class="mb-6">
    <div class="flex items-center space-x-4">
        ...
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Tambah Slider Baru</h1>
            <p class="text-gray-600 mt-1">Tambahkan gambar slider untuk halaman beranda</p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-lg shadow-sm p-6">
    <form action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-6">
            ...
            <!-- Image -->
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Gambar Slider <span class="text-red-500">*</span></label>
                ...
                @error('image')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
                <x-image-hint dimensions="1920×800" ratio="12:5" max-size="5MB" formats="JPG, PNG" note="Simpan konten utama di area TENGAH gambar — sisi kiri/kanan dapat terpotong di layar kecil." />
