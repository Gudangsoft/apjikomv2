...
@section('page-title', 'Tambah Changelog')
...
<div class="mb-6">
    <div class="flex items-center space-x-4">
        ...
        <h3 class="text-2xl font-bold text-gray-900">Tambah Changelog Baru</h3>
    </div>
</div>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <select name="type" required
                    ...
                    <option value="bugfix" {{ old('type') == 'bugfix' ? 'selected' : '' }}>Bugfix (Perbaikan Bug)</option>
                    <option value="security" {{ old('type') == 'security' ? 'selected' : '' }}>Security (Keamanan)</option>
                </select>
                @error('type')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
