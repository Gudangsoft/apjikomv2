        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between py-4">
                <div class="flex items-center space-x-4">
                    ...
                    @endif
                    <div>
                        <h1 class="text-xl font-bold">APJIKOM</h1>
                        <p class="text-xs text-purple-200">Member Dashboard</p>
                    </div>
                </div>
        ...
        <aside class="w-64 bg-white dark:bg-gray-800 shadow-lg">
            <nav class="p-4 space-y-2">
                ...
                <a href="{{ route('member.events.my') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('member.events.my') ? 'bg-purple-100 text-purple-700' : 'text-gray-700 hover:bg-gray-100' }} transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('journals.index') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('journals.*') ? 'bg-purple-100 text-purple-700' : 'text-gray-700 hover:bg-gray-100' }} transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
