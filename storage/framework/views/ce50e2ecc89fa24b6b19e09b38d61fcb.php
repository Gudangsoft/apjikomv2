...
<?php $__env->startSection('title', 'Edit Template Sertifikat'); ?>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-lg">
        ...
        <form method="POST" action="<?php echo e(route('admin.certificate-templates.update', $certificateTemplate)); ?>" enctype="multipart/form-data" class="p-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           name="name" 
                           id="name" 
                           value="<?php echo e(old('name', $certificateTemplate->name)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <img src="<?php echo e(asset('storage/' . $certificateTemplate->template_image)); ?>" 
                         alt="<?php echo e($certificateTemplate->name); ?>"
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description', $certificateTemplate->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center">
                    <input type="checkbox" 
                           ...
                           id="is_active" 
                           value="1"
                           <?php echo e(old('is_active', $certificateTemplate->is_active) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\LPKD-APJI\APJIKOM\resources\views/admin/certificates/templates/edit.blade.php ENDPATH**/ ?>