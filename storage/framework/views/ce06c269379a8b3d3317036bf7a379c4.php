...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="bg-gray-50 rounded-lg p-6 mb-6">
            ...
            <div id="certificateTemplateField" class="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-4 <?php echo e(old('has_certificate', $event->has_certificate) ? '' : 'hidden'); ?>">
                ...
                <?php if($event->certificate_template): ?>
                <div class="mb-3">
                    <p class="text-sm text-gray-600 mb-2">Template saat ini:</p>
                    <img src="<?php echo e(asset('storage/' . $event->certificate_template)); ?>" alt="Certificate Template" class="max-w-full rounded shadow border">
                </div>
                <?php endif; ?>
                ...
                <div>
                    ...
                    <input type="file" name="certificate_template" accept="image/*"
                           class="w-full px-4 py-2 border rounded focus:ring-2 focus:ring-[#00629B] <?php $__errorArgs = ['certificate_template'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
