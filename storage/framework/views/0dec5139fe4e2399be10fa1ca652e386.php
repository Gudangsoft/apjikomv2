...
<div class='max-w-7xl mx-auto px-4 py-6'>
    ...
    <?php if(session('profile_complete')): ?>
    ...
    <div id="viewMode" class='bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden'>
        ...
        <div class='bg-gradient-to-r from-purple-600 to-purple-800 p-6'>
            <div class='flex items-center justify-between flex-wrap gap-4'>
                <div class='flex items-center gap-3 text-white'>
                    ...
                    <?php if($lastResetRequest): ?>
                        <span class="ml-4 px-3 py-1 rounded-full text-sm font-semibold"
                            <?php if($lastResetRequest->status == 'pending'): ?>
                                style="background:#fef3c7;color:#b45309;"
                            <?php elseif($lastResetRequest->status == 'approved'): ?>
                                style="background:#dcfce7;color:#166534;"
                            <?php elseif($lastResetRequest->status == 'rejected'): ?>
        ...
        <div class='p-6 lg:p-8'>
            ...
            <div class='flex items-center gap-4 mb-8 pb-6 border-b border-gray-200'>
                ...
                <div class='flex-grow'>
                    <h3 class='text-2xl font-bold text-gray-800'><?php echo e(Auth::user()->name); ?></h3>
                    <div class='flex items-center gap-2 mt-2 flex-wrap'>
                        <div class='flex items-center gap-2 bg-blue-600 text-white px-4 py-1.5 rounded-lg shadow-sm'>
                            ...
                            <p class='text-sm font-medium'><?php echo e(Auth::user()->email); ?></p>
                        </div>
            ...
            <div class='mb-6 bg-gradient-to-br from-purple-50 via-blue-50 to-purple-50 border-2 border-purple-200 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300'>
                <div class='flex items-start gap-4'>
                    ...
                    <div class='flex-1'>
                        ...
                        <a href="<?php echo e(route('directory.index')); ?>" target="_blank" 
                ...
                <div class='lg:col-span-2 space-y-5'>
                    ...
                    <div class='grid grid-cols-1 sm:grid-cols-2 gap-6'>
                        <div class='bg-gray-50 p-4 rounded-xl border border-gray-200'>
                            ...
                            <p class='text-lg font-bold text-purple-600'><?php echo e($member->member_number ?? '-'); ?></p>
                        </div>
                        
                        <div class='bg-gray-50 p-4 rounded-xl border border-gray-200'>
                            <p class='text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1'>Tipe Member</p>
                            <p class='text-lg font-semibold text-gray-800'><?php echo e($member->member_type ?? '-'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class='space-y-4'>
                        <div class='flex flex-col sm:flex-row sm:gap-6 border-b border-gray-100 pb-3'>
                            ...
                            <p class='text-gray-800 font-medium'><?php echo e(Auth::user()->name); ?></p>
                        </div>
                        ...
                        <div class='flex flex-col sm:flex-row sm:gap-6 border-b border-gray-100 pb-3'>
                            ...
                            <p class='text-gray-800'><?php echo e($member->phone ?? '-'); ?></p>
                        </div>
                        
                        <div class='flex flex-col sm:flex-row sm:gap-6 border-b border-gray-100 pb-3'>
                            <p class='text-sm font-semibold text-gray-600 sm:w-40 flex-shrink-0'>Institusi</p>
                            <p class='text-gray-800'><?php echo e($member->institution_name ?? '-'); ?></p>
                        </div>
                        
                        <div class='flex flex-col sm:flex-row sm:gap-6 border-b border-gray-100 pb-3'>
                            <p class='text-sm font-semibold text-gray-600 sm:w-40 flex-shrink-0'>Jabatan</p>
                            <p class='text-gray-800'><?php echo e($member->position ?? '-'); ?></p>
                        </div>
                        ...
                        <div class='flex flex-col sm:flex-row sm:gap-6 border-b border-gray-100 pb-3'>
                            ...
                            <div>
                                ...
                                <a href="<?php echo e($member->website); ?>" target="_blank" class='text-blue-600 hover:text-blue-800 hover:underline break-all font-medium'><?php echo e($member->website); ?></a>
                                <?php else: ?>
                        ...
                        <div class='flex flex-col sm:flex-row sm:gap-6 pb-3'>
                            ...
                            <p class='text-gray-800'><?php echo e($member->address ?? '-'); ?></p>
                        </div>
                        ...
                        <div class='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                            ...
                            <div class='flex items-center gap-3 bg-purple-50 p-4 rounded-xl'>
                                ...
                                <div>
                                    ...
                                    <p class='text-sm font-bold text-gray-800'><?php echo e(\Carbon\Carbon::parse($member->join_date)->format('d M Y')); ?></p>
                                </div>
                            </div>
                            <?php endif; ?>
                    ...
                    <!-- Directory Settings -->
                    <form action='<?php echo e(route("member.profile.update")); ?>' method='POST' enctype='multipart/form-data'>
                        <?php echo csrf_field(); ?>
                        ...
                        <input type='hidden' name='phone' value='<?php echo e($member->phone); ?>'>
                        <input type='hidden' name='institution_name' value='<?php echo e($member->institution_name); ?>'>
                        <input type='hidden' name='position' value='<?php echo e($member->position); ?>'>
                        <input type='hidden' name='website' value='<?php echo e($member->website); ?>'>
                        <input type='hidden' name='address' value='<?php echo e($member->address); ?>'>
                        ...
                        <div class='mt-6 pt-6 border-t border-gray-200'>
                                ...
                                <div class='flex items-start gap-4'>
                                    <div class='flex-shrink-0 pt-1'>
                                        ...
                                        <input type='checkbox' 
                                               ...
                                               <?php echo e($member->show_in_directory ? 'checked' : ''); ?>
                                    ...
                                    <div class='flex-1'>
                                        ...
                                        <p class='text-sm text-gray-600 mb-3'>
                                            Centang untuk menampilkan profil Anda di <a href='<?php echo e(route("directory.index")); ?>' target='_blank' class='text-blue-600 hover:text-blue-800 underline font-semibold'>halaman direktori anggota</a>. Jika tidak dicentang, profil Anda tidak akan tampil dan data tidak dapat dilihat oleh anggota lain.
                                        </p>
                                        
                                        <!-- Current Status -->
                                        <div id='directoryStatusBox' class='p-3 rounded-lg <?php echo e($member->show_in_directory ? "bg-green-100 border border-green-300" : "bg-red-100 border border-red-300"); ?>'>
                                            <div class='flex items-center gap-2'>
                                                <svg id='statusIcon' class='w-5 h-5 <?php echo e($member->show_in_directory ? "text-green-600" : "text-red-600"); ?>' fill='currentColor' viewBox='0 0 20 20'>
                                                    <?php if($member->show_in_directory): ?>
                                                        <path fill-rule='evenodd' d='M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z' clip-rule='evenodd'/>
                                                    <?php else: ?>
                                                        <path fill-rule='evenodd' d='M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z' clip-rule='evenodd'/>
                                                ...
                                                <span id='statusText' class='text-sm font-semibold <?php echo e($member->show_in_directory ? "text-green-800" : "text-red-800"); ?>'>
                                                    Status: <?php echo e($member->show_in_directory ? 'Tampil di Direktori' : 'Tidak Tampil di Direktori'); ?>
                            ...
                            <textarea name='bio' rows='5' id='bioTextarea' placeholder='Ceritakan sedikit tentang diri Anda atau institusi Anda...' class='w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all resize-none'><?php echo e(old('bio', $member->bio)); ?></textarea>
                        ...
                        <div class='mb-4'>
                            ...
                            <div class='mb-3 p-3 bg-green-50 border-2 border-green-200 rounded-xl'>
                                <div class='flex items-center justify-between'>
                                    ...
                                    <div class='flex items-center space-x-2'>
                                        <a href='<?php echo e(asset("storage/" . $member->cv_file)); ?>' target='_blank' class='text-xs text-blue-600 hover:text-blue-700 underline'>Lihat CV</a>
                                        <button type='button' onclick='document.getElementById("deleteCV").value="1"; this.closest(".bg-green-50").classList.add("hidden"); document.getElementById("cvUploadSection").classList.remove("hidden"); document.getElementById("cvFileInput").disabled = false;' class='text-xs text-red-600 hover:text-red-700'>Hapus</button>
                                    </div>
                                </div>
                            </div>
                            <input type='hidden' name='delete_cv' id='deleteCV' value='0'>
                            <?php endif; ?>
                            <div id='cvUploadSection' class='<?php echo e($member->cv_file ? "hidden" : ""); ?>'>
                                <input type='file' name='cv_file' id='cvFileInput' accept='.pdf,.doc,.docx' class='w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100' <?php echo e($member->cv_file ? 'disabled' : ''); ?>>
                        ...
                        <div class='mb-4'>
                            ...
                            <input type='text' name='expertise' value='<?php echo e(old("expertise", $member->expertise)); ?>' maxlength='300' placeholder='Contoh: Komunikasi Massa, Jurnalistik Digital, Media Sosial' class='w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all'>
                        ...
                        <div class='space-y-3'>
                            ...
                            <div class='flex items-center gap-3'>
                                ...
                                <input type='url' name='linkedin' value='<?php echo e(old("linkedin", $member->linkedin)); ?>' placeholder='https://linkedin.com/in/username' class='flex-1 px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm'>
                            </div>
                            ...
                            <div class='flex items-center gap-3'>
                                ...
                                <input type='url' name='facebook' value='<?php echo e(old("facebook", $member->facebook)); ?>' placeholder='https://facebook.com/username' class='flex-1 px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm'>
                            </div>
                            ...
                            <div class='flex items-center gap-3'>
                                ...
                                <input type='text' name='twitter' value='<?php echo e(old("twitter", $member->twitter)); ?>' placeholder='@username atau URL lengkap' class='flex-1 px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-sky-500 focus:ring-2 focus:ring-sky-200 transition-all text-sm'>
                            </div>
                            ...
                            <div class='flex items-center gap-3'>
                                ...
                                <input type='text' name='instagram' value='<?php echo e(old("instagram", $member->instagram)); ?>' placeholder='@username atau URL lengkap' class='flex-1 px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-pink-500 focus:ring-2 focus:ring-pink-200 transition-all text-sm'>
                            </div>
                        </div>
                        ...
                        <div class='space-y-4'>
                            ...
                            <div class='flex items-center gap-3'>
                                ...
                                <input type='url' name='google_scholar_link' value='<?php echo e(old("google_scholar_link", $member->google_scholar_link)); ?>' placeholder='https://scholar.google.com/...' class='flex-1 px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm'>
                            </div>
                            ...
                            <div class='flex items-center gap-3'>
                                ...
                                <input type='url' name='sinta_link' value='<?php echo e(old("sinta_link", $member->sinta_link)); ?>' placeholder='https://sinta.kemdikbud.go.id/...' class='flex-1 px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-all text-sm'>
                            </div>
                            ...
                            <div class='flex items-center gap-3'>
                                ...
                                <input type='url' name='orcid_link' value='<?php echo e(old("orcid_link", $member->orcid_link)); ?>' placeholder='https://orcid.org/...' class='flex-1 px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all text-sm'>
                            </div>
                            ...
                            <div class='flex items-center gap-3'>
                                ...
                                <input type='url' name='scopus_link' value='<?php echo e(old("scopus_link", $member->scopus_link)); ?>' placeholder='https://www.scopus.com/...' class='flex-1 px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all text-sm'>
                            </div>
                        </div>
                ...
                <div class='lg:col-span-1'>
                    <div class='sticky top-6'>
                        ...
                        <div class='relative group'>
                            <?php if($member->photo): ?>
                                <img src="<?php echo e(Storage::url($member->photo)); ?>" alt="Foto Profil" class='w-full aspect-[3/4] object-cover rounded-2xl shadow-xl border-4 border-white ring-2 ring-gray-200'>
                            <?php else: ?>
                            ...
                            <form action="<?php echo e(route('member.profile.upload-photo')); ?>" method="POST" enctype="multipart/form-data" id="photoForm">
                                <?php echo csrf_field(); ?>
                        ...
                        <?php if($member->photo): ?>
                        <form action="<?php echo e(route('member.profile.delete-photo')); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus foto?')" class='mt-3'>
                            <?php echo csrf_field(); ?>
                        ...
                        <!-- Request KTA Button -->
                        <?php if(!$member->member_card && $member->photo && $member->address && $member->phone): ?>
                            <?php if(!$member->card_requested): ?>
                                <form action="<?php echo e(route('member.request-card')); ?>" method="POST" class='mt-4'>
                                    <?php echo csrf_field(); ?>
                        ...
                        <?php if($member->member_card && $member->photo && $member->address && $member->phone): ?>
                            <?php if(!$member->card_update_requested): ?>
                                <form action="<?php echo e(route('member.request-card-update')); ?>" method="POST" class='mt-4'>
                                    <?php echo csrf_field(); ?>
    ...
    <div id="editMode" style="display:none" class='bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden'>
        ...
        <form action="<?php echo e(route('member.profile.update')); ?>" method="POST" class='p-6 lg:p-8'>
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            ...
            <div class='grid grid-cols-1 md:grid-cols-2 gap-5'>
                ...
                <div>
                    ...
                    <input type='text' id='name' name='name' value='<?php echo e(old("name", Auth::user()->name)); ?>' required class='w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition'>
                </div>
                ...
                <div>
                    ...
                    <input type='email' id='email' name='email' value='<?php echo e(old("email", Auth::user()->email)); ?>' required class='w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition'>
                </div>

                <!-- Nomor Telepon -->
                <div>
                    <label for='phone' class='block text-sm font-semibold text-gray-700 mb-2'>Nomor Telepon</label>
                    <input type='text' id='phone' name='phone' value='<?php echo e(old("phone", $member->phone)); ?>' placeholder='08123456789' class='w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition'>
                </div>

                <!-- Institusi -->
                <div>
                    <label for='institution_name' class='block text-sm font-semibold text-gray-700 mb-2'>Nama Institusi</label>
                    <input type='text' id='institution_name' name='institution_name' value='<?php echo e(old("institution_name", $member->institution_name)); ?>' placeholder='Nama institusi Anda' class='w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition'>
                </div>

                <!-- Jabatan -->
                <div>
                    <label for='position' class='block text-sm font-semibold text-gray-700 mb-2'>Jabatan</label>
                    <input type='text' id='position' name='position' value='<?php echo e(old("position", $member->position)); ?>' placeholder='Jabatan Anda' class='w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition'>
                </div>

                <!-- Website -->
                <div>
                    <label for='website' class='block text-sm font-semibold text-gray-700 mb-2'>Website</label>
                    <input type='url' id='website' name='website' value='<?php echo e(old("website", $member->website)); ?>' placeholder='https://example.com' class='w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition'>
                </div>
                ...
                <div class='md:col-span-2'>
                    ...
                    <textarea id='address' name='address' rows='3' placeholder='Contoh:&#10;Jl. Majapahit No. 605 Semarang&#10;RT 03 RW 05 Kelurahan Semarang Tengah&#10;Jawa Tengah 50192' class='w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition'><?php echo e(old('address', $member->address)); ?></textarea>
    ...
    <div class='bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mt-6'>
        ...
        <div class='p-6 lg:p-8'>
            <!-- Form Edit Nama User -->
            <form action="<?php echo e(route('member.profile.update-name')); ?>" method="POST" class='mb-8 pb-8 border-b border-gray-200'>
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                ...
                <div class='bg-blue-50 border-l-4 border-blue-500 p-4 mb-4'>
                    <p class='text-sm text-blue-700'>
                        <strong>Email:</strong> <?php echo e(Auth::user()->email); ?> (tidak bisa diubah)
                    </p>
                </div>
                ...
                <div class='mb-4'>
                    ...
                    <input type='text' 
                           ...
                           class='w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ["name"];
...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- Form Edit Password -->
            <form action="<?php echo e(route('member.profile.update-password')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                ...
                <div class='mb-4'>
                    ...
                    <input type='password' 
                           ...
                           class='w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 <?php $__errorArgs = ["current_password"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class='mb-4'>
                    ...
                    <input type='password' 
                           id='new_password'
                           name='password' 
                           class='w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 <?php $__errorArgs = ["password"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class='bg-gradient-to-br from-orange-50 to-amber-50 border-l-4 border-orange-500 rounded-xl p-6 shadow-sm'>
                ...
                <?php if($lastRequest && in_array($lastRequest->status, ['approved', 'rejected'])): ?>
                    <!-- Show last request status -->
                    <div class='p-4 rounded-lg flex items-start gap-3 shadow-sm border-l-4 mb-4
                        <?php if($lastRequest->status == 'approved'): ?> border-green-400 bg-green-50
                        <?php elseif($lastRequest->status == 'rejected'): ?> border-red-400 bg-red-50
                        <?php endif; ?>'>
                        <svg class='w-5 h-5 flex-shrink-0 mt-0.5'
                            <?php if($lastRequest->status == 'approved'): ?> fill='none' stroke='currentColor' viewBox='0 0 24 24' style='color:#22c55e;'
                            <?php elseif($lastRequest->status == 'rejected'): ?> fill='none' stroke='currentColor' viewBox='0 0 24 24' style='color:#ef4444;'
                            <?php endif; ?>>
                            <?php if($lastRequest->status == 'approved'): ?>
                                <path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'/>
                            <?php elseif($lastRequest->status == 'rejected'): ?>
                                <path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M6 18L18 6M6 6l12 12'/>
                            <?php endif; ?>
                        </svg>
                        <div>
                            <p class='font-semibold 
                                <?php if($lastRequest->status == 'approved'): ?> text-green-800
                                <?php elseif($lastRequest->status == 'rejected'): ?> text-red-800
                                <?php endif; ?>'>
                                <?php if($lastRequest->status == 'approved'): ?>
                            ...
                            <p class='text-sm mt-1 
                                <?php if($lastRequest->status == 'approved'): ?> text-green-700
                                <?php elseif($lastRequest->status == 'rejected'): ?> text-red-700
                                <?php endif; ?>'>
                                <?php if($lastRequest->status == 'approved'): ?>
                            ...
                            <p class='text-xs mt-1'>Dibuat: <?php echo e($lastRequest->created_at->diffForHumans()); ?></p>
                            <?php if($lastRequest->reason): ?>
                                <div class='mt-2 text-xs'><span class='font-semibold'>Alasan:</span> <?php echo e($lastRequest->reason); ?></div>
                            <?php endif; ?>
                        </div>
                    </div>
...
<div id="resetRequestModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
        ...
        <form action="<?php echo e(route('member.password-reset-request')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
...
<script src="<?php echo e(asset('js/password-strength-meter.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.member', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\LPKD-APJI\APJIKOM\resources\views/member/profile-v2.blade.php ENDPATH**/ ?>