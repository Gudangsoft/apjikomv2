            ...
            <a href="<?php echo e($social->url); ?>" 
               ...
               class="bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-xl p-4 transition-all duration-300 hover:scale-105 group">
                <div class="flex flex-col items-center space-y-3">
                    ...
                    <?php if(str_contains($platformName, 'facebook')): ?>
                    ...
                    <?php elseif(str_contains($platformName, 'instagram')): ?>
                    ...
                    <?php elseif(str_contains($platformName, 'twitter') || str_contains($platformName, 'x')): ?>
                    ...
                    <?php elseif(str_contains($platformName, 'youtube')): ?>
                    ...
                    <?php elseif(str_contains($platformName, 'linkedin')): ?>
                    ...
                    <?php elseif(str_contains($platformName, 'telegram')): ?>
                    ...
                    <div class="text-center">
                        <p class="font-semibold text-white text-sm"><?php echo e($social->name); ?></p>
                        <?php if($social->note): ?>
                        <p class="text-xs text-purple-100 mt-1 line-clamp-2"><?php echo e($social->note); ?></p>
                        <?php endif; ?>
                    </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <?php $__currentLoopData = $socialMedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($social->url); ?>" 
                   ...
                   title="<?php echo e($social->note); ?>">
                    
                    <?php if($social->icon): ?>
                        <!-- Uploaded Icon -->
                        <div class="w-12 h-12 mb-3 flex items-center justify-center">
                            <img src="<?php echo e(asset('storage/' . $social->icon)); ?>" 
                                 alt="<?php echo e($social->name); ?>" 
                                 class="w-12 h-12 object-contain group-hover:scale-110 transition-transform duration-300">
                        </div>
                    <?php elseif($social->icon_class): ?>
                        <!-- Icon Class -->
                        <div class="w-12 h-12 mb-3 flex items-center justify-center">
                            <i class="<?php echo e($social->icon_class); ?> text-4xl text-gray-700 group-hover:text-purple-600 transition-colors duration-300"></i>
                        </div>
                    <?php else: ?>
                        <!-- Default Icon -->
