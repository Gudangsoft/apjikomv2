...
<head>
    ...
    <title>Login - <?php echo e($siteName); ?> Admin</title>
    
    <?php if($globalSiteFavicon ?? null): ?>
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-20 h-20 bg-white rounded-2xl shadow-lg mb-4">
                <?php if($siteLogo): ?>
                    <img src="<?php echo e(asset('storage/' . $siteLogo)); ?>" alt="<?php echo e($siteName); ?>" class="w-16 h-16 object-contain">
                <?php else: ?>
            ...
            <h1 class="text-3xl font-bold text-white mb-2"><?php echo e($siteName); ?></h1>
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" id="loginForm">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-purple-600 hover:text-purple-700 font-medium">
                            Forgot password?
                        </a>
                    <?php endif; ?>
                </div>
                ...
                <div class="mb-6">
                    <label for="captcha" class="block text-sm font-semibold text-gray-700 mb-2">
                        ...
                        <span class="inline-flex items-center px-3 py-1 bg-purple-100 text-purple-700 rounded-lg font-bold text-lg mx-1">
                            <?php echo e(session('captcha_num1', rand(1, 10))); ?> + <?php echo e(session('captcha_num2', rand(1, 10))); ?>
...
<?php /**PATH D:\LPKD-APJI\APJIKOM\resources\views/auth/login.blade.php ENDPATH**/ ?>