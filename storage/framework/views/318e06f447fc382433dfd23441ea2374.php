...
<div class="bg-green-50 border-l-4 border-green-400 p-6 mb-6 rounded-lg">
    <div class="flex items-start">
        ...
        <div class="flex-1">
            <p class="text-sm text-green-800"><?php echo session('success'); ?></p>
        </div>
    </div>
</div>
<?php endif; ?>
...
<div class="bg-red-50 border-l-4 border-red-400 p-6 mb-6 rounded-lg">
    <div class="flex items-start">
        ...
        <div class="flex-1">
            <p class="text-sm text-red-800 mb-3"><?php echo session('error'); ?></p>
            <?php if(str_contains(session('error'), 'belum ada') || str_contains(session('error'), 'migration')): ?>
            <a href="<?php echo e(route('admin.run-migration')); ?>" 
...
<?php if(session('error') && str_contains(session('error'), 'migration')): ?>
    ...
    <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-6 border-l-4 border-[#00629B]">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900"><?php echo e($stats['total_news']); ?></p>
                <div class="mt-2 flex items-center">
                    <span class="text-xs font-medium text-green-600 bg-green-50 px-2 py-1 rounded"><?php echo e($stats['published_news']); ?> Published</span>
                </div>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-6 border-l-4 border-purple-500">
        <div class="flex items-center justify-between">
            <div>
                ...
                <div class="mt-2 flex items-center">
                    <span class="text-xs font-medium text-purple-600 bg-purple-50 px-2 py-1 rounded"><?php echo e($stats['upcoming_events']); ?> Mendatang</span>
                </div>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-6 border-l-4 border-green-500">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900"><?php echo e($stats['total_members']); ?></p>
                <div class="mt-2 flex items-center">
                    <span class="text-xs font-medium text-green-600 bg-green-50 px-2 py-1 rounded"><?php echo e($stats['active_members']); ?> Aktif</span>
                </div>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-6 border-l-4 border-yellow-500">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900"><?php echo e($stats['pending_members']); ?></p>
                <div class="mt-2 flex items-center">
    ...
    <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-6 border-l-4 border-purple-600">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900"><?php echo e(number_format($membersByType['institution'] ?? 0)); ?><?php echo e(($membersByType['institution'] ?? 0) >= 1000 ? '+' : ''); ?></p>
                <div class="mt-2 flex items-center">
    ...
    <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-6 border-l-4 border-blue-600">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900"><?php echo e(number_format($membersByType['individual'] ?? 0)); ?><?php echo e(($membersByType['individual'] ?? 0) >= 1000 ? '+' : ''); ?></p>
                <div class="mt-2 flex items-center">
    ...
    <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-6 border-l-4 border-green-600">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900"><?php echo e(number_format($stats['active_members'])); ?><?php echo e($stats['active_members'] >= 1000 ? '+' : ''); ?></p>
                <div class="mt-2 flex items-center">
    ...
    <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-6 border-l-4 border-pink-600">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900"><?php echo e($satisfactionRate); ?>%</p>
                <div class="mt-2 flex items-center">
                    <a href="<?php echo e(route('admin.settings.index')); ?>" class="text-xs font-medium text-pink-600 bg-pink-50 px-2 py-1 rounded hover:bg-pink-100 transition-colors">Edit</a>
                </div>
            </div>
        ...
        <div class="flex items-center justify-between">
            <div class="flex-1">
                ...
                <div class="flex items-baseline gap-2">
                    <h3 class="text-3xl font-bold text-gray-900"><?php echo e($stats['total_registrations']); ?></h3>
                </div>
            </div>
            <div class="w-14 h-14 bg-gradient-to-br from-purple-50 to-purple-100 rounded-full flex items-center justify-center">
                <svg class="w-7 h-7 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow">
        <div class="flex items-center justify-between">
            <div class="flex-1">
                ...
                <div class="flex items-baseline gap-2">
                    <h3 class="text-3xl font-bold text-gray-900"><?php echo e($stats['pending_registrations']); ?></h3>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow">
        <div class="flex items-center justify-between">
            <div class="flex-1">
                ...
                <div class="flex items-baseline gap-2">
                    <h3 class="text-3xl font-bold text-gray-900"><?php echo e($stats['approved_registrations']); ?></h3>
...
<div class="bg-white rounded-xl shadow-sm p-6 mb-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <a href="<?php echo e(route('admin.news.create')); ?>" class="group flex flex-col items-center p-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-[#00629B] hover:bg-blue-50 transition-all">
        ...
        <a href="<?php echo e(route('admin.events.create')); ?>" class="group flex flex-col items-center p-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-purple-500 hover:bg-purple-50 transition-all">
        ...
        <a href="<?php echo e(route('admin.categories.create')); ?>" class="group flex flex-col items-center p-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-indigo-500 hover:bg-indigo-50 transition-all">
        ...
        <a href="<?php echo e(route('home')); ?>" target="_blank" class="group flex flex-col items-center p-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-green-500 hover:bg-green-50 transition-all">
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-start space-x-3 p-3 hover:bg-gray-50 rounded-lg transition">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-sm text-gray-800 font-medium"><?php echo e($activity->description); ?></p>
                    <div class="flex items-center space-x-2 mt-1">
                        <?php if($activity->user): ?>
                            <p class="text-xs text-gray-500">by <?php echo e($activity->user->name); ?></p>
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex items-center space-x-2">
                    <span class="px-2 py-1 bg-green-100 text-green-700 text-xs font-semibold rounded">
                        +<?php echo e($recentMemberCount ?? 0); ?> this week
                    </span>
                </div>
            </div>
        ...
        <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border-2 border-blue-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-blue-900"><?php echo e($stats['total_journals'] ?? 0); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border-2 border-purple-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-purple-900"><?php echo e($stats['total_event_registrations'] ?? 0); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-6 border-2 border-yellow-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-yellow-900"><?php echo e($cardsPending ?? 0); ?></p>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="p-6 border-b bg-gradient-to-r from-gray-50 to-white">
            <div class="flex justify-between items-center">
                ...
                <a href="<?php echo e(route('admin.news.index')); ?>" class="text-sm text-[#00629B] hover:text-[#003A5D] font-medium">Lihat Semua →</a>
            </div>
        </div>
        <div class="p-6">
            <div class="space-y-4">
                ...
                <div class="flex items-start space-x-3 pb-4 border-b last:border-0 hover:bg-gray-50 p-3 rounded-lg transition">
                    <div class="flex-shrink-0 w-2 h-2 mt-2 rounded-full <?php echo e($news->is_published ? 'bg-green-500' : 'bg-gray-400'); ?>"></div>
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium text-gray-900 truncate"><?php echo e($news->title); ?></p>
                        <p class="text-xs text-gray-500 mt-1"><?php echo e($news->category->name); ?> • <?php echo e($news->published_at?->format('d M Y') ?? 'Draft'); ?></p>
                    </div>
                    <a href="<?php echo e(route('admin.news.edit', $news)); ?>" class="text-[#00629B] hover:text-[#003A5D]">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                        </svg>
                    </a>
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="p-6 border-b bg-gradient-to-r from-gray-50 to-white">
            <div class="flex justify-between items-center">
                ...
                <a href="<?php echo e(route('admin.members.index')); ?>" class="text-sm text-[#00629B] hover:text-[#003A5D] font-medium">Lihat Semua →</a>
            </div>
        </div>
        <div class="p-6">
            <div class="space-y-4">
                <?php $__empty_1 = true; $__currentLoopData = $pending_members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-center justify-between pb-4 border-b last:border-0 hover:bg-gray-50 p-3 rounded-lg transition">
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-gray-500 mt-1"><?php echo e(ucfirst($member->member_type)); ?> • <?php echo e($member->created_at->diffForHumans()); ?></p>
                    </div>
            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <?php if($stats['pending_registrations'] > 0): ?>
                            <span class="text-xs text-yellow-600 font-medium"><?php echo e($stats['pending_registrations']); ?> menunggu review</span>
                        <?php endif; ?>
                    </div>
                </div>
                <a href="<?php echo e(route('admin.registrations.index')); ?>" class="text-sm text-purple-600 hover:text-purple-700 font-medium">Lihat Semua →</a>
            </div>
        </div>
        <div class="p-6">
            <div class="space-y-4">
                <?php $__empty_1 = true; $__currentLoopData = $pending_registrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-start justify-between pb-4 border-b last:border-0 hover:bg-gray-50 p-3 rounded-lg transition">
                    <div class="flex-1">
                        <div class="flex items-center gap-2 mb-1">
                            <span class="px-2 py-0.5 text-xs font-semibold rounded <?php echo e($registration->type == 'individu' ? 'bg-blue-100 text-blue-700' : 'bg-green-100 text-green-700'); ?>">
                                <?php echo e(ucfirst($registration->type)); ?>
                        ...
                        <?php if($registration->type == 'prodi'): ?>
                            <p class="text-xs text-gray-600"><?php echo e($registration->institution); ?></p>
                        <?php endif; ?>
                        <p class="text-xs text-gray-500 mt-1">
                            <?php echo e($registration->email); ?> • <?php echo e($registration->created_at->diffForHumans()); ?>

                        </p>
                    </div>
                    <a href="<?php echo e(route('admin.registrations.show', $registration)); ?>" class="ml-3 px-3 py-1.5 bg-purple-500 hover:bg-purple-600 text-white text-xs font-medium rounded-lg transition">
                        Review
                    </a>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                    ...
                    <span class="text-2xl font-bold text-blue-600">
                        <?php echo e(\App\Models\Registration::where('type', 'individu')->count()); ?>
                ...
                <div class="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                    ...
                    <span class="text-2xl font-bold text-green-600">
                        <?php echo e(\App\Models\Registration::where('type', 'prodi')->count()); ?>
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="px-2 py-1 bg-yellow-100 text-yellow-700 text-xs font-semibold rounded">
                                <?php echo e($stats['pending_registrations']); ?>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="px-2 py-1 bg-green-100 text-green-700 text-xs font-semibold rounded">
                                <?php echo e($stats['approved_registrations']); ?>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="px-2 py-1 bg-red-100 text-red-700 text-xs font-semibold rounded">
                                <?php echo e(\App\Models\Registration::where('status', 'rejected')->count()); ?>
...
<div class="bg-white rounded-xl shadow-sm mt-6 overflow-hidden">
    <div class="p-6 border-b bg-gradient-to-r from-gray-50 to-white">
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('admin.events.index')); ?>" class="text-sm text-[#00629B] hover:text-[#003A5D] font-medium">Lihat Semua →</a>
        </div>
    </div>
    <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="group border-2 rounded-lg p-4 hover:border-[#00629B] hover:shadow-md transition-all bg-gradient-to-br from-white to-gray-50">
                <div class="flex items-start justify-between mb-3">
                    <div class="flex-1">
                        <h4 class="font-semibold text-sm text-gray-900 mb-2 group-hover:text-[#00629B] transition"><?php echo e(Str::limit($event->title, 50)); ?></h4>
                    ...
                    <a href="<?php echo e(route('admin.events.edit', $event)); ?>" class="text-[#00629B] hover:text-[#003A5D] opacity-0 group-hover:opacity-100 transition">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                        </svg>
                    </a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const membersByStatus = <?php echo json_encode($membersByStatus, 15, 512) ?>;
    ...
    const membersByType = <?php echo json_encode($membersByType, 15, 512) ?>;
    ...
    const topInstitutions = <?php echo json_encode($topInstitutions, 15, 512) ?>;
    ...
    const registrationTrend = <?php echo json_encode($registrationTrend, 15, 512) ?>;
    ...
    const eventRegsByStatus = <?php echo json_encode($eventRegsByStatus, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\LPKD-APJI\APJIKOM\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>