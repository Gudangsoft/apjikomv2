    ...
    public function run(): void
    {
        ...
        $events = [
            [
                ...
                'event_time' => '08:00:00',
                'registration_link' => 'https://apjikom.or.id/register/semnasjo2025',
            ...
            [
                ...
                'event_time' => '09:00:00',
                'registration_link' => 'https://apjikom.or.id/register/workshop-akreditasi',
                'has_registration' => true,
                'has_certificate' => true,
            ...
            [
                ...
                'event_time' => '08:30:00',
                'registration_link' => 'https://apjikom.or.id/register/rakornas',
                'has_registration' => true,
            ...
            [
                ...
                'event_time' => '13:00:00',
                'registration_link' => 'https://apjikom.or.id/register/webinar-etika',
                'has_registration' => true,
                'has_certificate' => true,
            ...
            [
                ...
                'event_time' => '10:00:00',
                'registration_link' => 'https://apjikom.or.id/register/pelatihan-ojs',
                'has_registration' => true,
                'has_certificate' => true,
            ...
            [
                ...
                'event_time' => '08:00:00',
                'registration_link' => 'https://apjikom.or.id/register/icics2025',
                'has_registration' => true,
                'has_certificate' => true,
            ...
            [
                ...
                'event_time' => '15:00:00',
                'registration_link' => 'https://apjikom.or.id/register/sosialisasi-kemitraan',
                'has_registration' => true,
                'has_certificate' => false,
                'participant_quota' => 200,
                'registration_fee' => 0,
